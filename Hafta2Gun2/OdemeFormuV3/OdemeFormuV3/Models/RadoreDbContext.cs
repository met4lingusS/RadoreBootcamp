...
public partial class RadoreDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-9A51HHS\\METALINGUSS;Initial Catalog=RadoreDB;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
